## Описание
Финальная работа по ручному тестированию: <https://skyprooo.yonote.ru/share/48c57915-0201-44f2-abb0-cf4de95a360f>
...
4. Устанавливаем зависимости из файла `requirements.txt`. Команда `pip install -r requirements.txt`
...
1. Перейдите в нужную директорию `cd diplom`
2. Команда для запуска тестов `pytest tests/test_ui.py --alluredir=./allure_result_ui`
3. После завершения тестирования вводим команду для просмотра отчета о тестировании `allure serve allure_result_ui`
